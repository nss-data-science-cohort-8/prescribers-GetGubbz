...
SELECT SUM(p.total_drug_cost) AS money, d.opioid_drug_flag, d.antibiotic_drug_flag,
CASE 
...
INNER JOIN prescription AS p
USING(drug_name)
GROUP BY drug_type, d.opioid_drug_flag, d.antibiotic_drug_flag
ORDER BY money DESC;
...
SELECT drug_name, p.total_claim_count, d.opioid_drug_flag,
CASE
	WHEN d.opioid_drug_flag = 'Y' THEN 'opioid'
	ELSE 'N/A'
END AS is_opioid
...
SELECT pre.nppes_provider_first_name, pre.nppes_provider_last_org_name, drug_name, p.total_claim_count, d.opioid_drug_flag,
CASE
	WHEN d.opioid_drug_flag = 'Y' THEN 'opioid'
	ELSE 'N/A'
END AS is_opioid
